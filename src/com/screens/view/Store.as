package com.screens.view
{
	...
	public class Store extends Sprite
	{
		...
		{
			Monotorizer.logEvent("store","showBuyButtons");
		...
		{
			// TODO Auto Generated method stub
			Monotorizer.logEvent("store","onPurchased");
			Session.fullVersionEnabled=true;
			complete.dispatch();
		}
	}
